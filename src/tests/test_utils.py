...
import shutil
import glob
from utils import create_folder, post_processing_annotations, rm_high_polyphony
...
def test_postprocessing(folder, checked_folder, out_csv):
    ...
    print(df.to_dict())
    check = (df == pd.DataFrame({'filename': {0: 'material/post_processing/5.wav',
                                 ...
                                 'start': {0: 0.008, 1: 4.969, 2: 2.183, 3: 2.406,
                                           4: 3.099, 5: 3.406, 6: 3.684, 7: 6.406},
                                 'end': {0: 5.546, 1: 9.609, 2: 2.488, 3: 5.2,
                                         4: 3.36, 5: 6.2, 6: 5.624, 7: 10.0},
                                 'class': {0: 'Cat', 1: 'Speech', 2: 'Dishes', 3: 'Speech',
