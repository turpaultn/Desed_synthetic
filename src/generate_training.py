...
if __name__ == '__main__':
    ...
    parser.add_argument('--outfolder', type=str, default=osp.join('..', 'training', 'soundscapes_generated'))
    ...
    # SCAPER SETTINGS
    fg_folder = osp.join("..", "training", "soundbank", "foreground")
    bg_folder = osp.join("..", "training", "soundbank", "background")
    # JSON file
    param_file = 'event_occurences_train.json'
